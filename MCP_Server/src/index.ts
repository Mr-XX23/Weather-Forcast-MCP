...
// local imports
import { makeNWSRequest, formatAlert } from "./tools/makeWeatherRequest.js";
import { AlertsResponse, PointsResponse, ForecastResponse, ForecastPeriod } from "./types.js";

const server = new McpServer({
  name: "weather-server",
  version: "1.0.0",
  description: "A server that provides weather information using the National Weather Service API",
  capabilities: {
    resources: {},
    tools: {},
  },
